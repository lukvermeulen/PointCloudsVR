...
#define ORIGINAL_FILE_NAME "UE4Editor-PointCloudRuntime-Win64-DebugGame.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME CPP_PointCloudsVR
...
#define POINTCLOUDRUNTIME_API DLLEXPORT
